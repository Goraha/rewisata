...
export default function Modal(props:any) {
  ...
  const [Modal, setModal] = useState(statusModal);
  const handleOnClick = () => {
    setModal(!Modal);
  }
  return (
...
<div id="default-modal" aria-hidden="true" className={`${statusModal ? "block" : "invisible"} fixed top-0 right-0 left-0 md:left-1/3 z-50 w-full`}>
